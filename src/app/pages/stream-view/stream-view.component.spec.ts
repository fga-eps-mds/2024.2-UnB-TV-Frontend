...
describe('StreamViewComponent', () => {
  ...
  describe("Getting today's schedules", () => {
    ...
    it('should call getTodaysSchedule and handle an error', () => {
      ...
      spyOn(console, 'error');  // Simula a chamada para console.error

      component.getTodaysSchedule();

      expect(mySpy).toHaveBeenCalled();
      expect(console.error).toHaveBeenCalledWith(errorResponse);// Verifica se o erro foi registrado no console
    });
  });
